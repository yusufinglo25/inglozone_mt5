...
const MANUALLY_DOCUMENTED_OPERATIONS = new Set([
  ...
  'POST /api/wallet/razorpay/deposit',
  'POST /api/wallet/razorpay/deposit/verify',
  'POST /api/wallet/bank-transfer/deposit',
  'GET /api/wallet/bank-transfer/bank-details',
  'POST /api/wallet/bank-transfer/{transactionId}/proof',
  ...
  'GET /api/admin/users',
  'GET /api/admin/users/permission-catalog',
  'GET /api/admin/users/permission-context',
  'GET /api/admin/users/permission-roles',
  'POST /api/admin/users/permission-roles',
  'PATCH /api/admin/users/permission-roles/{roleId}',
  'PATCH /api/admin/users/assign-permission-role',
  ...
  'PATCH /api/admin/payments/gateways/{gatewayCode}',
  'GET /api/admin/payments/bank-accounts',
  'POST /api/admin/payments/bank-accounts',
  'PATCH /api/admin/payments/bank-accounts/{bankAccountId}',
  'DELETE /api/admin/payments/bank-accounts/{bankAccountId}',
  'GET /api/admin/payments/bank-transfers',
  'GET /api/admin/payments/bank-transfers/{transactionId}',
  'POST /api/admin/payments/bank-transfers/{transactionId}/approve',
  'POST /api/admin/payments/bank-transfers/{transactionId}/reject',
