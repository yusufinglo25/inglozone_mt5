...
router.get('/currency', controller.getCurrencyContext)
router.get('/countries', controller.getSupportedCountries)
...
router.get('/withdrawal/options', controller.getWithdrawalOptions)
router.get('/withdrawal/accounts', controller.getWithdrawalAccounts)
router.post('/withdrawal/accounts', controller.createWithdrawalAccount)
router.post('/withdrawal/request-otp', controller.requestWithdrawalOTP)
router.post('/withdrawal/verify-otp', controller.verifyWithdrawalOTP)
